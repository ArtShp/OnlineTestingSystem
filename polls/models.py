...
class Student(models.Model):
    ...
    learn_class = models.ForeignKey(Classes, verbose_name='Класс', default=1, on_delete=models.CASCADE)
...
class Question(models.Model):
    quiz = models.ForeignKey(Quiz, verbose_name='Тест', default=1, on_delete=models.CASCADE)
...
class Answer(models.Model):
    question = models.ForeignKey(Question, verbose_name='Вопрос', default=1, on_delete=models.CASCADE)
